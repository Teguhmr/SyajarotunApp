...
import com.teguh.sejarahislam.MainActivity;
...
import static com.teguh.sejarahislam.common.Music.OFF;
	...
	private void setMusicButton() {
		if (OFF) {
			...
			try {
				...
				mainActivity.stopService(new Intent(mainActivity, BackgroundMusicService.class));
